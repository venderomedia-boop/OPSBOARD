...
const seed = {
  sites:[
    {id:'site-1',customerId:'cust-1',name:'C233 - Meridian Office Park, Block A',address:'14 Meridian Way',city:'Manchester',postcode:'M1 4BT',accessCode:'1842',accessInstructions:'Use loading-bay entrance. Report to reception before accessing plant areas.',siteNotes:'Permit required for roof access. Visitor parking is limited before 10:00.',contactName:'Facilities Desk',contactPhone:'0161 555 0118',contactEmail:'facilities@meridian.example',active:true},
    {id:'site-2',customerId:'cust-7',name:'Arden House',address:'31 King Street',city:'Manchester',postcode:'M2 6AA',accessCode:'',accessInstructions:'Sign in with concierge and collect plant-room key.',siteNotes:'Loading restrictions apply between 08:00 and 09:30.',contactName:'Building Manager',contactPhone:'0161 555 0127',contactEmail:'manager@arden.example',active:true},
    ...ppmDemoSeed.sites,
  ],
...
function normalize(saved){
  ...
  s.siteAssignments=s.siteAssignments.map(a=>({
    ...
    lastSkippedJobId:a.lastSkippedJobId||null,
