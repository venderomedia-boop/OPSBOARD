...
const invoiceImport = "import { createInvoiceStub, deleteInvoiceStub, getInvoiceQueueInfo, getInvoiceStub, listInvoiceStubs, resetInvoiceQueue, updateInvoiceStub } from './invoice-queue.mjs';";
...
if (!source.includes(submissionExportImport)) {
  source = source.replace(invoiceImport, `${invoiceImport}\n${submissionExportImport}`);
  changed = true;
}
