...
export function renderEmailIntakePanel(){
  ...
  return `<section class="panel email-intake-panel" id="email-intake">
    <div class="panel-head">
      ...
      <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;justify-content:flex-end"><button type="button" class="panel-action" data-email-demo>How it works</button><div class="email-intake-summary"><b>${Number(s.needsReview||0)}</b> need review · <b>${Number(s.ready||0)}</b> ready</div></div>
    </div>
